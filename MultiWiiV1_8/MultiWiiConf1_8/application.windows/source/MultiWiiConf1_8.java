...
public class MultiWiiConf1_8 extends PApplet {
...
int yellow_ = color(200, 200, 20), green_ = color(30, 120, 30), red_ = color(120, 30, 30);
...
public void setup() {
  ...
  controlP5.addTextlabel("headlabel","ALT",xo,y3);
  controlP5.addTextlabel("altitude","HEAD",xo,y4);
  ...
  confP[ROLL] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confP_ROLL",0,xParam+40,yParam+20,30,14));confP[ROLL].setDecimalPrecision(1);confP[ROLL].setMultiplier(0.1f);confP[ROLL].setMax(20);
  confI[ROLL] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confI_ROLL",0,xParam+75,yParam+20,40,14));confI[ROLL].setDecimalPrecision(3);confI[ROLL].setMultiplier(0.001f);confI[ROLL].setMax(0.250f);
  ...
  confP[PITCH] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confP_PITCH",0,xParam+40,yParam+40,30,14));confP[PITCH].setDecimalPrecision(1);confP[PITCH].setMultiplier(0.1f);confP[PITCH].setMax(20);
  confI[PITCH] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confI_PITCH",0,xParam+75,yParam+40,40,14));confI[PITCH].setDecimalPrecision(3);confI[PITCH].setMultiplier(0.001f);confI[PITCH].setMax(0.250f);
  ...
  confP[YAW] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confP_YAW",0,xParam+40,yParam+60,30,14));confP[YAW].setDecimalPrecision(1);confP[YAW].setMultiplier(0.1f);confP[YAW].setMax(20);
  confI[YAW] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confI_YAW",0,xParam+75,yParam+60,40,14));confI[YAW].setDecimalPrecision(3);confI[YAW].setMultiplier(0.001f);confI[YAW].setMax(0.250f);
  ...
  confP[ALT] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confP_ALT",0,xParam+40,yParam+80,30,14));confP[ALT].setDecimalPrecision(1);confP[ALT].setMultiplier(0.1f);confP[ALT].setMax(20);
  confI[ALT] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confI_ALT",0,xParam+75,yParam+80,40,14));confI[ALT].setDecimalPrecision(3);confI[ALT].setMultiplier(0.001f);confI[ALT].setMax(0.250f);
  ...
  confP[VEL] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confP_VEL",0,xParam+40,yParam+100,30,14));confP[VEL].setDecimalPrecision(1);confP[VEL].setMultiplier(0.1f);confP[VEL].setMax(20);
  confI[VEL] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confI_VEL",0,xParam+75,yParam+100,40,14));confI[VEL].setDecimalPrecision(3);confI[VEL].setMultiplier(0.001f);confI[VEL].setMax(0.250f);
  ...
  confP[LEVEL] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confP_LEVEL",0,xParam+40,yParam+120,30,14));confP[LEVEL].setDecimalPrecision(1);confP[LEVEL].setMultiplier(0.1f);confP[LEVEL].setMax(25);
  confI[LEVEL] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confI_LEVEL",0,xParam+75,yParam+120,40,14));confI[LEVEL].setDecimalPrecision(3);confI[LEVEL].setMultiplier(0.001f);confI[LEVEL].setMax(0.250f);

  confP[MAG] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confP_MAG",0,xParam+40,yParam+138,30,14));confP[MAG].setDecimalPrecision(1);confP[MAG].setMultiplier(0.1f);confP[MAG].setMax(15);
  ...
  yawRate = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("yawRate",0,xParam+160,yParam+60,30,14));yawRate.setDecimalPrecision(2);yawRate.setMultiplier(0.01f);
  yawRate.setDirection(Controller.HORIZONTAL);yawRate.setMin(0);yawRate.setMax(1);yawRate.setColorBackground(red_); 
  dynamic_THR_PID = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("dynamic_THR_PID",0,xParam+300,yParam+12,30,14));dynamic_THR_PID.setDecimalPrecision(2);dynamic_THR_PID.setMultiplier(0.01f);
  ...
  confRC_RATE = controlP5.addNumberbox("RC RATE",1,xParam+40,yParam+183,30,14);confRC_RATE.setDecimalPrecision(2);confRC_RATE.setMultiplier(0.02f);confRC_RATE.setLabel("");
  ...
  confRC_EXPO = controlP5.addNumberbox("RC EXPO",0,xParam+40,yParam+200,30,14);confRC_EXPO.setDecimalPrecision(2);confRC_EXPO.setMultiplier(0.01f);confRC_EXPO.setLabel("");
  ...
  motSliderV0  = controlP5.addSlider("motSliderV0",1000,2000,1500,0,0,10,100);motSliderV0.setDecimalPrecision(0);motSliderV0.hide();
  motSliderV1  = controlP5.addSlider("motSliderV1",1000,2000,1500,0,0,10,100);motSliderV1.setDecimalPrecision(0);motSliderV1.hide();
  motSliderV2  = controlP5.addSlider("motSliderV2",1000,2000,1500,0,0,10,100);motSliderV2.setDecimalPrecision(0);motSliderV2.hide();
  motSliderV3  = controlP5.addSlider("motSliderV3",1000,2000,1500,0,0,10,100);motSliderV3.setDecimalPrecision(0);motSliderV3.hide();
  motSliderV4  = controlP5.addSlider("motSliderV4",1000,2000,1500,0,0,10,100);motSliderV4.setDecimalPrecision(0);motSliderV4.hide();
  motSliderV5  = controlP5.addSlider("motSliderV5",1000,2000,1500,0,0,10,100);motSliderV5.setDecimalPrecision(0);motSliderV5.hide();
...
public void draw() {
  ...
  background(80);
  textFont(font15);
  text("MultiWii conf",0,16);text("v1.8", 0, 32);
  ...
  text("Volt:",xGraph-5,yGraph-2);  text(bytevbat/10.0f,xGraph+50,yGraph-2);
  ...
  pushMatrix();
  camera(xObj,yObj,300/tan(PI*60.0f/360.0f),xObj/2+30,yObj/2-40,0,0,1,0);
  translate(xObj,yObj);
  ...
  if (multiType == 1) { //TRI
    ...
    ellipse(-size,-0.55f*size,size,size);ellipse(size,-0.55f*size,size,size);ellipse(-size,+0.55f*size,size,size);
    ellipse(size,+0.55f*size,size,size);ellipse(0,-size,size,size);ellipse(0,+size,size,size);
    line(-size,-0.55f*size,0,0);line(size,-0.55f*size,0,0);line(-size,+0.55f*size,0,0);
    line(size,+0.55f*size,0,0);line(0,+size,0,0);  line(0,-size,0,0);
    noLights();
    textFont(font12);
    ...
    line(0,0, 1.8f*size,size);line(1.8f*size,size,1.8f*size,size-30);  line(1.8f*size,size-30,0,-1.5f*size);
    line(0,0, -1.8f*size,+size);line(-1.8f*size,size,-1.8f*size,+size-30);    line(-1.8f*size,size-30,0,-1.5f*size);
    noLights();
    textFont(font12);
    ...
    ellipse(-0.55f*size,-size,size,size);ellipse(-0.55f*size,size,size,size);ellipse(+0.55f*size,-size,size,size);
    ellipse(+0.55f*size,size,size,size);ellipse(-size,0,size,size);ellipse(+size,0,size,size);
    line(-0.55f*size,-size,0,0);line(-0.55f*size,size,0,0);line(+0.55f*size,-size,0,0);
    line(+0.55f*size,size,0,0);line(+size,0,0,0);  line(-size,0,0,0);
    noLights();
    textFont(font12);
...
public void ACC_ROLL(boolean theFlag) {axGraph = theFlag;}
public void ACC_PITCH(boolean theFlag) {ayGraph = theFlag;}
public void ACC_Z(boolean theFlag) {azGraph = theFlag;}
public void GYRO_ROLL(boolean theFlag) {gxGraph = theFlag;}
public void GYRO_PITCH(boolean theFlag) {gyGraph = theFlag;}
public void GYRO_YAW(boolean theFlag) {gzGraph = theFlag;}
public void BARO(boolean theFlag) {baroGraph = theFlag;}
public void HEAD(boolean theFlag) {magGraph = theFlag;}
public void MAGX(boolean theFlag) {magxGraph = theFlag;}
public void MAGY(boolean theFlag) {magyGraph = theFlag;}
public void MAGZ(boolean theFlag) {magzGraph = theFlag;}
public void DEBUG1(boolean theFlag) {debug1Graph = theFlag;}
public void DEBUG2(boolean theFlag) {debug2Graph = theFlag;}
public void DEBUG3(boolean theFlag) {debug3Graph = theFlag;}
public void DEBUG4(boolean theFlag) {debug4Graph = theFlag;}
...
public void READ() {
  ...
  confP[LEVEL].setValue(byteP[LEVEL]/10.0f);confI[LEVEL].setValue(byteI[LEVEL]/1000.0f);
  confP[MAG].setValue(byteP[MAG]/10.0f);
  confRC_RATE.setValue(byteRC_RATE/50.0f);
  confRC_EXPO.setValue(byteRC_EXPO/100.0f);
  rollPitchRate.setValue(byteRollPitchRate/100.0f);
  yawRate.setValue(byteYawRate/100.0f);

  dynamic_THR_PID.setValue(byteDynThrPID/100.0f);
  ...
  for(int i=0;i<6;i++) {
    if ((PApplet.parseByte(activation[i])&32) >0) checkbox[i].activate(5); else checkbox[i].deactivate(5);if ((PApplet.parseByte(activation[i])&16) >0) checkbox[i].activate(4); else checkbox[i].deactivate(4);
    if ((PApplet.parseByte(activation[i])&8) >0) checkbox[i].activate(3); else checkbox[i].deactivate(3);if ((PApplet.parseByte(activation[i])&4) >0) checkbox[i].activate(2); else checkbox[i].deactivate(2);
    if ((PApplet.parseByte(activation[i])&2) >0) checkbox[i].activate(1); else checkbox[i].deactivate(1);if ((PApplet.parseByte(activation[i])&1) >0) checkbox[i].activate(0); else checkbox[i].deactivate(0);
  }
...
public void WRITE() {
  ...
  int p = 0;
   ...
   for(int i =0;i<32;i++)    g_serial.write(PApplet.parseChar(s[i]));
}
...
public void processSerialData() {
  ...
  if (g_serial.read() == 'M') {
    ...
    if (inBuf[frame_size-1] == 'M') {  // Multiwii @ arduino send all data to GUI
      ...
      for(int i=0;i<6;i++) activation[i] = read8();                                   //101
      pMeterSum = read16();
...
class cGraph {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#ECE9D8", "MultiWiiConf1_8" });
  }
}
